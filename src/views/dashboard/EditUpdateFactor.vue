<template>
    ...
    <form class="container m-5">
        ...
        <div class="form-group row" v-if="factor_type === 'awarded_quest'">
            ...
            <div class="col-8">
                <div class="custom-control custom-radio custom-control-inline">
                    <input name="radio2" id="radio2_0" type="radio" class="custom-control-input" value="download_app"
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                <div class="input-group">
                    <input v-model="valid_minutes" id="text2" name="text2" placeholder="Kac Dakika Gecerli" type="text"
                        class="form-control" aria-describedby="text2HelpBlock" required="true">
                    <div class="input-group-append">
                        <div class="input-group-text">
                ...
                <span id="text2HelpBlock" class="form-text text-muted">Bu urunun takviyesi kac dakika boyunca gecerli
                    kalacak</span>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-8">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    <input name="radio" v-model="one_time_usage" id="radio_1" type="radio" class="custom-control-input"
                        value="false" aria-describedby="radioHelpBlock">
        ...
        <div class="form-group row">
            <div class="offset-4 col-8">
                <button name="submit" v-click="printall" class="btn btn-primary">Submit</button>
            </div>
        </div>
    </form>
